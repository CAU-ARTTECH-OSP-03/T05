        ...
        try:
            ...
            if type_of_exercise == 1:
                ...
                if left_knee_angle < 90 and left_knee_angle > 70 and right_knee_angle < 90 and right_knee_angle > 70 and stage =='down':
                    ...
                    if left_hip_angle < 90 and left_hip_angle > 70 and right_hip_angle < 90 and right_hip_angle > 70:
                        stage="down"
                
                if left_knee_angle > 160 and right_knee_angle > 160 and left_hip_angle > 160 and right_hip_angle > 160:
                    if left_knee_angle > 160 and right_knee_angle > 160 and left_hip_angle > 160 and right_hip_angle > 160:
                        stage = "up"
                        counter +=1
                        print(counter)
                        
            elif type_of_exercise == 3:
                ...
                if left_elbow_angle > 160 and right_elbow_angle > 160:
                    stage = "up"
                if left_elbow_angle < 90 and left_elbow_angle > 70 and right_elbow_angle < 90 and right_elbow_angle > 70 and stage =='down':
                    stage="down"
                    counter +=1
                    print(counter)
